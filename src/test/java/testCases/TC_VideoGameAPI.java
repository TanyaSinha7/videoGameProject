...
public class TC_VideoGameAPI {
	...
	public void test_getAllVideoGames()
	{
		...
		.when()
		   .get("http://localhost:8081/swagger-ui/index.html#/Video_Games")
	...
	@Test(priority=2)
	public void test_addNewVideoaGame()
	{
		HashMap data=new HashMap();
		 data.put("id","100");
		 data.put("name","Spider-Man");
		 data.put("releaseDate", "2020-03-17T11:59:00.282Z");
	 ...
	 @Test(priority=3)
	  public void test_getVideoGame()
	    ...
	    public void test_UpdateVideoGame()
	    {
	    	HashMap data=new HashMap();
			 data.put("id","100");
			 data.put("name","Spi-Man");
			 data.put("releaseDate", "2020-03-17T11:57:00.282Z");
			 ...
			 .then()
			    ...
			    .log().body()
			    .body("videoGame.id", equalTo("100"))
			    .body("videoGame.name", equalTo("Spi-Man"));
	     }
